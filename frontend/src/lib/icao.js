...
// carriers we expect on the Europe map. Unknown codes show the raw 3-letter
// prefix.
...
// ICAO airport codes → city/airport label. Major European + main intercontinental.
...
// ICAO aircraft type codes → human-readable model. Most common European fleet.
export const AIRCRAFT_TYPES = {
  ...
  E170: "E-Jet E170", E175: "E-Jet E175", E190: "E-Jet E190", E195: "E-Jet E195",
  E290: "E-Jet E2 E190", E295: "E-Jet E2 E195",
  CRJ7: "CRJ-700", CRJ9: "CRJ-900", CRJX: "CRJ-1000",
  AT72: "ATR 72", AT76: "ATR 72-600", AT43: "ATR 42", AT46: "ATR 42-600",
  DH8D: "Dash 8 Q400",
  // Private jets (commonly seen in EU)
  GLF5: "Gulfstream G550", GLF6: "Gulfstream G650", G280: "Gulfstream G280",
  GLEX: "Bombardier Global Express", GL7T: "Global 7500",
...
export function callsignToAirline(cs) {
  return ((cs || "").trim().slice(0, 3) || "").toUpperCase();
}
